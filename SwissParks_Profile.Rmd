...
### DATA LOADING
```{r echo=TRUE}
#Data loading: we need to define the column type, to ensure that date is in the correct form.
...
flickr_04 <- as_tbl_time(flickr, index = DATE) #We identify the date as an index

flickr_04 <- filter(flickr_04, DATE >= as.Date("2004-01-01")) # we create a new dataframe just for the data after 2004
...
flickr_04nat <- filter(flickr_04, USE!=100, USE!=120, USE!=140, USE!=160) # The expression USE! means avoid/reduce
...
db <- flickr_04nat #We create a copy for future use
...
summary(area) #Statistical summary of area (km2)
```
...
#Statistical summary of pictures
summary(photos)
```
...
```{r echo=TRUE}
general <- data.frame("Parks"= area_park$PARK, "km2"= area_park$km, "Photos"= photos$photo, "Photos_per"= photos$ratio_photos, "Photos_km"=round((photos$photo/area$km),2),"Users"=users_flickr$user, "Users_per"=users_flickr$ratio_users, "Users_km"=round((users_flickr$user/area$km),2))
...
#png("C:\\Users\\dmarinoc\\Documents\\GitHub\\Flickr_SwissParks\\season_park.png")       
...
write.csv(daily_park,"C:\\Users\\dmarinoc\\Documents\\GitHub\\Flickr_SwissParks\\Daily_Park.csv", row.names = FALSE)
...
#png("C:\\Users\\dmarinoc\\Documents\\GitHub\\Flickr_SwissParks\\daily_park.png")       
...
#TEST 1: 
#png("C:\\Users\\dmarinoc\\Documents\\GitHub\\Flickr_SwissParks\\daily_park_Mosaic1.png")       
...
```{r echo=TRUE}
#TEST 2:
#png("C:\\Users\\dmarinoc\\Documents\\GitHub\\Flickr_SwissParks\\daily_park_Mosaic2.png")       
...
coul <- colorRampPalette(c("beige", "green"))(10)
